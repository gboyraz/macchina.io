...
// Avioos.cpp
//
// The bundle container application for avioos
//
...
class Avioos: public ServerApplication
{
public:
	Avioos():
		_errorHandler(*this),
...
protected:
	...
	void defineOptions(OptionSet& options)
	{
		...
		options.addOption(
			Option("help", "h", "Display help information on command line arguments.")
				.required(false)
				.repeatable(false)
				.callback(OptionCallback<Avioos>(this, &Avioos::handleHelp)));
		...
		options.addOption(
			Option("config-file", "c", "Load configuration data from a file.")
				...
				.repeatable(true)
				.argument("file")
				.callback(OptionCallback<Avioos>(this, &Avioos::handleConfig)));
	}
	...
	void displayHelp()
	{
		...
		helpFormatter.setHeader(
			"\n"
			"The avioos server.\n"
			"Copyright (c) 2018 by Avioos LLC.\n"
			"All rights reserved.\n\n"
